...
//                    lastPiece = currentPiece;
    ...
    private void loadURLS(){
        ...
        urls.add("src\\sample\\Images\\Flag.png");
        urls.add("src\\sample\\Images\\private.png");
        urls.add("src\\sample\\Images\\Sergeant.png");
        urls.add("src\\sample\\Images\\1stLieutenant.png");
        urls.add("src\\sample\\Images\\2ndLieutenenant.png");
        urls.add("src\\sample\\Images\\Captain.png");
        urls.add("src\\sample\\Images\\Major.png");
        urls.add("src\\sample\\Images\\Liutenant Colonel.png");
        urls.add("src\\sample\\Images\\Colonel.png");
        urls.add("src\\sample\\Images\\1StarGeneral.png");
        urls.add("src\\sample\\Images\\2StarGeneral.png");
        urls.add("src\\sample\\Images\\3StarGeneral.png");
        urls.add("src\\sample\\Images\\4StarGeneral.png");
        urls.add("src\\sample\\Images\\5Star.jpg");
        urls.add("src\\sample\\Images\\Spy.png");
